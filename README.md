...
- [Marketing Mindset](https://github.com/axelfreeman/marketing-mindset) - A marketer's operating mindset for AI agents: 3-month horizon, fast testable hypotheses, competitor-first research, and per-channel minimum test volumes before a result can be judged (50–100 sends as a smoke test, ~1,500–2,000 per variant for a reply-rate verdict, 100–200 visitors for a landing page). MIT licensed.
